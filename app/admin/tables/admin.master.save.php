...
if (isset($_POST["save-masters"])) {
    ...
    if (isset($_FILES["image"]) && $_FILES["image"]["name"] != "") {
        ...
        if (in_array(mime_content_type($tmpName), $types)) {
            ...
            } else if (!move_uploaded_file($tmpName, $_SERVER["DOCUMENT_ROOT"] . "/upload/$newName",)) {
    ...
    if (!isset($_SESSION["error"])) {
        Master::redacteMaster($_POST['save-masters'], $_POST["name"], $_POST["surname"], $name);
        header("location: /app/admin/tables/admin.masterPort.php");
    } else {
        header("location: /app/admin/tables/admin.showMaster.php  ");
    }
}
